...
<div>
	...
	<div style="width:80%;float:left"><center><h1 style="margin-top:55px";><b>National Institute of Technology Raipur</h1></center></div>
</div>
...
Designed & Developed by Sanjay Choudhary</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @Sanjay Choudhary</h5></center> 
  <hr class="new1">
<br>
</body>
</html>